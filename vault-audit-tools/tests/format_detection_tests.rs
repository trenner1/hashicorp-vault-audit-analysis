...
fn test_load_json_entity_mappings() {
    ...
    let mappings = load_entity_mappings(json_path.to_str().unwrap()).expect("Failed to load JSON mappings");
...
fn test_load_csv_entity_mappings() {
    ...
    let mappings = load_entity_mappings(csv_path.to_str().unwrap()).expect("Failed to load CSV mappings");
...
fn test_json_extension_detection() {
    ...
    let mappings = load_entity_mappings(json_path.to_str().unwrap()).expect("JSON extension detection failed");
...
fn test_csv_extension_detection() {
    ...
    let mappings = load_entity_mappings(csv_path.to_str().unwrap()).expect("CSV extension detection failed");
...
fn test_fallback_to_json_then_csv() {
    ...
    let mappings = load_entity_mappings(no_ext_path.to_str().unwrap()).expect("Fallback JSON parse failed");
...
fn test_fallback_csv_when_json_fails() {
    ...
    let mappings = load_entity_mappings(no_ext_path.to_str().unwrap()).expect("Fallback CSV parse failed");
...
fn test_empty_json_array() {
    ...
    let mappings = load_entity_mappings(json_path.to_str().unwrap()).expect("Empty JSON object should parse");
...
fn test_empty_csv_file() {
    ...
    let mappings = load_entity_mappings(csv_path.to_str().unwrap()).expect("Empty CSV should parse");
...
fn test_duplicate_entity_ids() {
    ...
    let mappings = load_entity_mappings(json_path.to_str().unwrap()).expect("Duplicates should parse");
